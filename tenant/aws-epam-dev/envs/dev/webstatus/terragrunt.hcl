...
inputs = {
  ...
  container_definitions = templatefile("container_definitions.json", {
    ...
    webmvc_url = dependency.webspa.outputs.lb_dns_name
    webspa_url = dependency.webspa.outputs.lb_dns_name
    webshoppingagg_url = dependency.webspa.outputs.lb_dns_name
    mobileshoppingagg_url = dependency.webspa.outputs.lb_dns_name
    ordering_url = dependency.webspa.outputs.lb_dns_name
    basket_url = dependency.webspa.outputs.lb_dns_name
    ...
    ordering_signalrhub_url = dependency.webspa.outputs.lb_dns_name
    ordering_backgroundtasks_url = dependency.webspa.outputs.lb_dns_name
  })
}
